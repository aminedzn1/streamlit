...
fig.add_trace(go.Scatter(
      ...
      y=y_1,
      mode = 'markers',
      marker=dict(symbol = "arrow-bar-down",color="red",size = 25,line=dict(width=2, color="Black")),
      name = 'Baseline (k€)'
)) 
...
fig.add_trace(go.Scatter(
      ...
      y=y_4,
      mode = 'markers',
      marker=dict(symbol = 'arrow-bar-up', color="green",size = 25,line=dict(width=2, color="Black")),
      name = 'Target (k€)'
)) 
