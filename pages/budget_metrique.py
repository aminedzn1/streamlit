...
fig.add_trace(go.Scatter(
      ...
      y=y_1,
      mode = 'markers',
      marker=dict(symbol = "line-ew-open",color="rgb(191,128,255)",size = 20,line=dict(width=5, color="rgb(191,128,255)")),
      name = 'Baseline EOY (k€)'
)) 
...
fig.add_trace(go.Scatter(
      ...
      y=y_4,
      mode = 'markers',
      marker=dict(symbol = 'line-ew-open', color="rgb(0,230,115)",size = 20,line=dict(width=5, color="rgb(0,230,115)")),
      name = 'Linear Taget (k€)'
)) 
