...
fig.add_trace(go.Scatter(
      ...
      y=y_1,
      mode = 'markers',
      marker=dict(symbol = "arrow-bar-down",color="red",size = 20,line=dict(width=2, color="#d9d9d9")),
      name = 'Baseline (k€)'
)) 
...
fig.add_trace(go.Scatter(
      ...
      y=y_4,
      mode = 'markers',
      marker=dict(symbol = 'arrow-bar-up', color="green",size = 20,line=dict(width=2, color="#d9d9d9")),
      name = 'Target (k€)'
)) 
