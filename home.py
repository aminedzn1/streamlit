...
with col2 :
    ...
    with col22 : 
        ...
        fig = px.pie(pd.DataFrame(np.array([['OCCURENCE', 2],['SARI', 10],['TEST', 4],['OTHERS', 3]]), columns = ['Source', 'Number']), values= 'Number', names='Source',hole = .7,color_discrete_sequence=px.colors.sequential.Blues_r)
