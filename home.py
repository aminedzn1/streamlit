...
if value < 50 :
    st.session_state.obj_acc = f'<p style="font-weight: 900; font-family:system-ui; color:Red; font-size: 30px;">{value} %</p>'

elif value > 50 and value < 85 :
    st.session_state.obj_acc = f'<p style="font-weight: 900; font-family:system-ui; color:rgb(230, 184, 0); font-size: 30px;">{value} %</p>'

elif value > 85 and value <= 100 :
    st.session_state.obj_acc = f'<p style="font-weight: 900; font-family:system-ui; color:Green; font-size: 30px;">{value} %</p>'


value = round(array_filled.mean()*100, 2)
if value < 50 :
    st.session_state.obj_fil = f'<p style="font-weight: 900; font-family:system-ui; color:Red; font-size: 30px;">{value} %</p>'

elif value > 50 and value < 85 :
    st.session_state.obj_fil = f'<p style="font-weight: 900; font-family:system-ui; color:rgb(230, 184, 0); font-size: 30px;">{value}  %</p>'

elif value > 85 and value <= 100 :
    st.session_state.obj_fil = f'<p style="font-weight: 900; font-family:system-ui; color:Green; font-size: 30px;">{value} %</p>'
###########################################################################################################
###########################################################################################################
#BUDGET
...
if delta < -tol :
    text = f"""
<p style ="font-weight: 900; font-family:system-ui; font-size:30px; color: White;">{y_evo[month]} k€ \n</p>
...
if 'Red' in list(sqe_count_domain['color']) :
    st.session_state.sqe_kpi = f'<p style="font-weight: 900; font-family:system-ui; color:Red; font-size: 30px;">{value}</p>'
elif 'rgb(230, 184, 0)' in list(sqe_count_domain['color'])  :
    st.session_state.sqe_kpi = f'<p style="font-weight: 900; font-family:system-ui; color:rgb(230, 184, 0); font-size: 30px;">{value}</p>'
else : 
    st.session_state.sqe_kpi = f'<p style="font-weight: 900; font-family:system-ui; color:Green; font-size: 30px;">{value}</p>'
###########################################################################################################
###########################################################################################################
#PROMO
...
text =f"<p style = 'font-weight: 900; font-family:system-ui; font-size:30px; color:White;'>{value}</p>"
...
text = f"<p style = 'font-weight: 900; font-family:system-ui; font-size: 30px;'>{value} %</p>"
...
###########################################################################################################    
    ...
    cas1.write('On time')
    cas1.markdown('<p style = "font-weight: 900; font-family: system-ui; color: Green; font-size: 30px;">12</p>', unsafe_allow_html=True)
    cas2.write('At risk')
    cas2.markdown('<p style = "font-weight: 900; font-family: system-ui; color: rgb(230, 184, 0); font-size: 30px;">1</p>', unsafe_allow_html=True)
    cas3.write('Late')
    cas3.markdown('<p style = "font-weight: 900; font-family: system-ui; color: Red; font-size: 30px;">3</p>', unsafe_allow_html=True)
...
with col2 :
    ...
    with col21 : 
        ...
        st.markdown(f'<p style="font-weight: 900; font-family:system-ui; color:Red; font-size: 30px;">44 %</p>', unsafe_allow_html=True)
        st.write('Acknowledgement on time')
        st.markdown(f'<p style="font-weight: 900; font-family:system-ui; color:Green; font-size: 30px;">89 %</p>', unsafe_allow_html=True)

    with col22 : 
        st.write('Number of open SMS cases')
        st.markdown('<p style = "font-weight: 900; font-family:system-ui; font-size: 30px;">34</p>', unsafe_allow_html= True)
    ...
    with col21b : 
        ...
        st.markdown(f'<p style="font-weight: 900; font-family:system-ui; color:white; font-size: 30px;">44 %</p>', unsafe_allow_html=True)
    ...
    with col22b :
        ...
        st.markdown(f'<p style="font-weight: 900; font-family:system-ui; color:White; font-size: 30px;">1/1</p>', unsafe_allow_html=True)
        st.markdown('Number of Internal findings on time')
        st.markdown(f'<p style="font-weight: 900; font-family:system-ui; color:White; font-size: 30px;">2/3</p>', unsafe_allow_html=True)
with col3 :
